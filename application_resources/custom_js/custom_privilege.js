...
//                    edit_privilege_form.reset();
                    window.location = site_url + '/settings/privilege_controller/manage_privileges';
                } else {
...
function save_privileges_from_system(system_code, user_id) {
    ...
    if ($($checkbox).is(':checked')) {
        $.post(site_url + '/user_privilege/user_privilege_controller/user_privileges_add_all', {system_code: system_code, user_id: user_id}, function(msg)
        {
            if (msg == 1) {
        ...
        $.post(site_url + '/user_privilege/user_privilege_controller/user_privileges_delete_all', {system_code: system_code, user_id: user_id}, function(msg)
        {
...
function save_privileges_from_user(privilige_code, user_id) {
    ...
    $.post(site_url + '/user_privilege/user_privilege_controller/add_user_privileges', {pri_code: privilige_code, user_id: user_id}, function(msg)
    {
