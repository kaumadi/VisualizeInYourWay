...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            'script_url' => $this->get_full_url().'/uploads/upload_files_stuff/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/uploads/upload_files_stuff/',
            'upload_url' => $this->get_full_url().'/uploads/upload_files_stuff/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
