                    ...
                    <div class="pull-right">
                        <div class="chat-toggler"> <a href="#" class="dropdown-toggle" id="my-task-list" data-placement="bottom"  data-content='' data-toggle="dropdown" data-original-title="Notifications">
                                <div class="user-details">
                                    <div class="username" id="user-name"> <!--<span id="notification-count" class="badge badge-important"></span>--> <?php echo ucfirst($this->session->userdata('USER_NAME')); ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp; </div>
                                </div>
                            ...
                            <div class="profile-pic">
                                <a href="<?php echo site_url(); ?>/user/user_profile_controller/view_profile">
                                    ...
                                    <?php } else { ?>
                                        <img src="<?php echo base_url(); ?>uploads/user_avatar/<?php echo $this->session->userdata('USER_PROPIC'); ?>"  alt="" data-src="<?php echo base_url(); ?>uploads/user_avatar/<?php echo $this->session->userdata('USER_PROPIC'); ?>" data-src-retina="<?php echo base_url(); ?>uploads/user_avatar/<?php echo $this->session->userdata('USER_PROPIC'); ?>" width="35" height="35" />
                        ...
                        <ul class="nav quick-section ">
                            <li class="quicklinks"> <a data-toggle="dropdown" class="dropdown-toggle  pull-right " href="#" id="user-options">
                                ...
                                <ul class="dropdown-menu  pull-right" role="menu" aria-labelledby="user-options">
                                    <li><a href="<?php echo site_url(); ?>/user/user_profile_controller/view_profile"> My Profile</a> </li>
                                    <!--<li><a href="<?php echo site_url(); ?>/event/event_controller/show_calander_view">My Calendar</a> </li>-->
                                    <li class="divider"></li>
...
<!--                            <img src="<?php echo base_url(); ?>application_resources/img/profiles/avatar.jpg"  alt="" data-src="<?php echo base_url(); ?>application_resources/img/profiles/avatar.jpg" data-src-retina="<?php echo base_url(); ?>application_resources/img/profiles/avatar2x.jpg" width="69" height="69" />
                        ...
                        <div class="user-info">
                            ...
                            <div class="status">Status
                                <?php if ($this->session->userdata('USER_ONLINE') == 'Y') { ?>
                                    <a href="#">
...
<!--            <script src="<?php echo base_url(); ?>application_resources/js/jszip.js" type="text/javascript"></script>
   ...
   <script src="<?php echo base_url(); ?>application_resources/js/CSVParser.js.js" type="text/javascript"></script>
