<div class="page-title">	
    <h3><?php echo $heading . ' - ' . ucfirst($user_detail->user_name) ?></h3>		
</div>


<div class="col-md-12">
    <ul class="nav nav-tabs" id="user_privi_tab">
        <?php
                        ...
                        if (count($privilege_masters) != 0) {
                            ...
                            <div class="divcls" >
                                <div class="row-fluid">
                                    <div class="checkbox check-primary" style="display: flex">
                                        ...
                                        <input type="checkbox" value="<?php echo $system->system_code; ?>" onclick="save_privileges_from_system(<?php echo $system->system_code; ?>,<?php echo $user_detail->user_id; ?>)" name="privilegessystem[]" id="privilegesystem<?php echo $system->system_code; ?>" class="checkbox msgsystemchk<?php echo $system->system_code; ?>">
                            ...
                            <?php foreach ($privilege_masters as $privilege_master) {
                                ...
                                <div>
                                    ...
                                    <p>
                                        <?php
                                        $privileges = $privilege_service->get_privileges_by_master_privilege_assigned_for_user($privilege_master->privilege_master_code, $user_detail->user_id,$system->system_code);
                                        ...
                                        <div class="divcls" >
                                            <div class="row-fluid">
                                                <div class="checkbox check-primary" style="display: flex">
                                                    ...
                                                    ?>  type="checkbox" value="<?php echo $privilege->privilege_code; ?>" onclick="save_privileges_from_user(<?php echo $privilege->privilege_code; ?>,<?php echo $user_id; ?>)" name="privileges[]" id="privilege<?php echo $privilege->privilege_code; ?>" class="checkbox chkbox<?php echo $system->system_code; ?>">
